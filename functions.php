...
if (!function_exists('fridays_for_future_paderborn_setup')) :
	/**
	 ...
	 */
	function fridays_for_future_paderborn_setup()
	{
		/*
		...
		function fridays_for_future_paderborn_menus()
		{

			$locations = array(
				'primary'  => __('Lower Desktop Horizontal Menu', 'fridays_for_future_paderborn'),
				'secondary' => __('Top Secondary Desktop Horizontal Menu', 'fridays_for_future_paderborn'),
				'mobile'   => __('Mobile Menu', 'fridays_for_future_paderborn'),
				'footer-top'   => __('Footer Top Button Menu', 'fridays_for_future_paderborn'),
				'footer-left'   => __('Footer Left Menu', 'fridays_for_future_paderborn'),
				'footer-right'   => __('Footer Right Menu', 'fridays_for_future_paderborn'),
				'social'   => __('Social Menu', 'fridays_for_future_paderborn'),
				'blog'   => __('Blog', 'fridays_for_future_paderborn'),
			);

			register_nav_menus($locations);
		}

		add_action('init', 'fridays_for_future_paderborn_menus');
		...
		add_theme_support('custom-background', apply_filters('fridays_for_future_paderborn_custom_background_args', array(
...
add_action('after_setup_theme', 'fridays_for_future_paderborn_setup');
 ...
 */
function fridays_for_future_paderborn_content_width()
{
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters('fridays_for_future_paderborn_content_width', 640);
}
add_action('after_setup_theme', 'fridays_for_future_paderborn_content_width', 0);
...
add_action('widgets_init', 'fridays_for_future_paderborn_widgets_init');
...
add_action('wp_enqueue_scripts', 'fridays_for_future_paderborn_scripts');
...
function cptui_register_my_cpts()
{
	...
	$labels = [
		...
		"name" => __("Veranstaltungen", "sunrisenationalchild"),
		"singular_name" => __("Veranstaltung", "sunrisenationalchild"),
	];

	$args = [
		// "label" => __("Events", "sunrisenationalchild"),
		"label" => __("Veranstaltungen", "sunrisenationalchild"),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
